...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="ID">
            <input type="text" id="myInput2" onkeyup="myFunction2()" placeholder="Name">
            <input type="text" id="myInput3" onkeyup="myFunction3()" placeholder="Email">
            </div>
       ...
       while ($res = $stmt->fetch()) {    
            ...
            echo "<td > <a href=\"deletecustomer.php?id=$res[customer_id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><div class='delete'>Delete</div></a></td>";
			echo "</tr>";
        }
        ?>
    </table>
