...
<body>
    ...
    <nav class='nav-container'>
        <div class="logo">
            <a href="index.php"> <img src="./icons/logo-1.jpg" alt=""> </a>
        </div>   
        <div class="menu1">
          <ul>
    ...
    <div class="body-container">
        <div class="sidebar">
         <h2>Contact Us</h2>
         <hr>
            <h4>Author : M.Alyan</h4>
            <h4>Email ID : alyankhanzada27@gmail.com</h4>
            <h4>GitHub : Books</h4>
            <h4>Phone : 0315234567</h4>
        </div>
    ...
    <!-- Start Footer -->
        ...
        <img class="l" src="./icons/logo-1.jpg" alt="">
